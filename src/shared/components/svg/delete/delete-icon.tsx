...
const DeleteIcon = ({height = "40px", width = "40px", fill = "#fff"}: DeleteIconProps) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 105.16 122.88" height={height} width={width} fill={fill}>
