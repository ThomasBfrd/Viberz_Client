...
const EditIcon = ({fill = "#fff", height = "40px", width = "40px"}: EditIconProps) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill={fill} height={height} width={width} x="0px" y="0px" viewBox="0 0 117.74 122.88" xmlSpace="preserve">
